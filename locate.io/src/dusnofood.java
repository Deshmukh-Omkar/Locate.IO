 ...
 * @author nayansaxena
 */
public class dusnofood extends javax.swing.JFrame {

    /**
     * Creates new form dusnofood
     */
    ...
    private void initComponents() {
        ...
        SagarGaire = new javax.swing.JButton();
        Hideout = new javax.swing.JButton();
        Bakenshke = new javax.swing.JButton();
        ...
        jLabel4.setText("Bake 'n' Shake");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 190, 110, 10));

        jLabel3.setFont(new java.awt.Font("Helvetica", 1, 12)); // NOI18N
        jLabel3.setText("Hideout");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 130, 180, 20));

        jLabel5.setFont(new java.awt.Font("Helvetica", 1, 12)); // NOI18N
        jLabel5.setText("Day '2' Day ");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 300, -1, 20));

        jLabel6.setFont(new java.awt.Font("Helvetica", 1, 12)); // NOI18N
        jLabel6.setText("Sagar Gaire");
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 230, -1, 20));

        SagarGaire.setIcon(new javax.swing.ImageIcon(getClass().getResource("/foods copy.png"))); // NOI18N
        SagarGaire.setBorderPainted(false);
        SagarGaire.setContentAreaFilled(false);
        SagarGaire.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                SagarGaireActionPerformed(evt);
            }
        });
        getContentPane().add(SagarGaire, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 300, 30, 20));

        Hideout.setIcon(new javax.swing.ImageIcon(getClass().getResource("/foods copy.png"))); // NOI18N
        Hideout.setBorderPainted(false);
        Hideout.setContentAreaFilled(false);
        Hideout.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                HideoutActionPerformed(evt);
            }
        });
        getContentPane().add(Hideout, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 130, 30, 20));

        Bakenshke.setIcon(new javax.swing.ImageIcon(getClass().getResource("/foods copy.png"))); // NOI18N
        Bakenshke.setBorderPainted(false);
        Bakenshke.setContentAreaFilled(false);
        Bakenshke.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BakenshkeActionPerformed(evt);
            }
        });
        getContentPane().add(Bakenshke, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 180, 30, 20));

        Day2day.setIcon(new javax.swing.ImageIcon(getClass().getResource("/foods copy.png"))); // NOI18N
        Day2day.setBorderPainted(false);
        Day2day.setContentAreaFilled(false);
        Day2day.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Day2dayActionPerformed(evt);
            }
        });
        getContentPane().add(Day2day, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 230, 30, 20));
    ...
    private void HideoutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_HideoutActionPerformed
        ...
        control = "hideout";
    }//GEN-LAST:event_HideoutActionPerformed

    private void BakenshkeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BakenshkeActionPerformed
        // TODO add your handling code here:
        Informationdialogbox.setVisible(true);
        Informationdialogbox.setBounds(896,0,896,470);
        Informationdialogbox.setLocationRelativeTo(null);
        control = "bakenshke";
    }//GEN-LAST:event_BakenshkeActionPerformed

    private void SagarGaireActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SagarGaireActionPerformed
        // TODO add your handling code here:
        Informationdialogbox.setVisible(true);
        Informationdialogbox.setBounds(896,0,896,470);
        Informationdialogbox.setLocationRelativeTo(null);
        control = "sagargaire";
    }//GEN-LAST:event_SagarGaireActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
    dusnomovie dusnomovie = new dusnomovie();
    dusnofood.this.setVisible(false);
    ...
    private void InformationdialogboxFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_InformationdialogboxFocusGained
        ...
        switch (control) {
            case "hideout":
            query = "select * FROM 10_no where place = 'Hideout';";
            break;
            case "bakenshke":
            query = "select * FROM 10_no where place = 'Bake N Shake';";
            break;
            case "sagargaire":
            query = "select * FROM 10_no where place = 'Sagar Gaire Fast Food';";
            break;
            case "day2day":
            query = "select * FROM 10_no where place = 'Day 2 Day';";
            break;
            default:
            break;
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dusnofood.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new dusnofood().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton Bakenshke;
    private javax.swing.JButton Day2day;
    private javax.swing.JButton Hideout;
    private javax.swing.JDialog Informationdialogbox;
    private javax.swing.JButton SagarGaire;
