 ...
 * @author nayansaxena
 */
public class Oldcitymovie extends javax.swing.JFrame {

    /**
     * Creates new form Oldcitymovie
     */
    ...
    private void initComponents() {
        ...
        bharat = new javax.swing.JButton();
        jLabel2 = new javax.swing.JLabel();
        alpana = new javax.swing.JButton();
        settingbutton = new javax.swing.JButton();
        jButton4 = new javax.swing.JButton();
        sangam = new javax.swing.JButton();
        ...
        jLabel4.setText("Alpana Cineplex");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 60, 110, -1));

        jLabel5.setFont(new java.awt.Font("Helvetica", 1, 12)); // NOI18N
        jLabel5.setText("Bharat Talkies");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 200, 100, 20));

        bharat.setIcon(new javax.swing.ImageIcon(getClass().getResource("/moviesymbol.png"))); // NOI18N
        bharat.setBorderPainted(false);
        bharat.setContentAreaFilled(false);
        bharat.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bharatActionPerformed(evt);
            }
        });
        getContentPane().add(bharat, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 200, 30, 20));

        jLabel2.setFont(new java.awt.Font("Helvetica", 1, 12)); // NOI18N
        jLabel2.setText("Sangam Cinema");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 140, 140, 20));

        alpana.setIcon(new javax.swing.ImageIcon(getClass().getResource("/moviesymbol.png"))); // NOI18N
        alpana.setBorderPainted(false);
        alpana.setContentAreaFilled(false);
        alpana.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                alpanaActionPerformed(evt);
            }
        });
        getContentPane().add(alpana, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 60, 30, 20));
        ...
        sangam.setIcon(new javax.swing.ImageIcon(getClass().getResource("/moviesymbol.png"))); // NOI18N
        sangam.setBorderPainted(false);
        sangam.setContentAreaFilled(false);
        sangam.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                sangamActionPerformed(evt);
            }
        });
        getContentPane().add(sangam, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 140, 30, 20));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/oldcitymoviemap.png"))); // NOI18N
    ...
    private void sangamActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sangamActionPerformed
        ...
        control = "sangam";
    }//GEN-LAST:event_sangamActionPerformed

    private void alpanaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_alpanaActionPerformed
        // TODO add your handling code here:
        Informationdialogbox.setVisible(true);
        Informationdialogbox.setBounds(896,0,896,470);
        Informationdialogbox.setLocationRelativeTo(null);
        control = "alpana";
    }//GEN-LAST:event_alpanaActionPerformed

    private void bharatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bharatActionPerformed
        // TODO add your handling code here:
        Informationdialogbox.setVisible(true);
        Informationdialogbox.setBounds(896,0,896,470);
        Informationdialogbox.setLocationRelativeTo(null);
        control = "bharat";
    }//GEN-LAST:event_bharatActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
    Oldcitymovie Oldcitymovie = new Oldcitymovie();
    Oldcitymovie.this.setVisible(false);
    ...
    private void InformationdialogboxFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_InformationdialogboxFocusGained
        ...
        switch (control) {
            case "sangam":
            query = "select * FROM oldcity where place = 'Sangam Cineplex';";
            break;
            case "alpana":
            query = "select * FROM oldcity where place = 'Alapana Talkies';";
            break;
            case "bharat":
            query = "select * FROM oldcity where place = 'Bharat Talkies';";
            break;
            default:
            break;
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Oldcitymovie.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Oldcitymovie().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton alpana;
    private javax.swing.JButton bharat;
    ...
    private javax.swing.JButton sangam;
